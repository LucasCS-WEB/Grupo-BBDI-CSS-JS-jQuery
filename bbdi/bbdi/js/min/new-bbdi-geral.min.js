    ...
    methods: {
        ...
        paginationBarSearch: function() {
            ...
            if ($("body").hasClass("New-BBDI-search")) {
                ...
                var serchResultInsertNumber = window.location.pathname.replace('/', "");

                $(".pagination-bar .display-desc .search-key").text(' "'+decodeURIComponent(serchResultInsertNumber)+'"');
        ...
        titleSidebarSearch: function() {
            ...
            if ($("body").hasClass("New-BBDI-search")) {
                setTimeout(function(){
                    var titleSearch = window.location.pathname.replace('/', "");
                    $(".title-search-single-navigator, .breadcrumb h2.titulo-sessao").text("Busca por " + decodeURIComponent(titleSearch));
                }, 500);
            }
        ...
        searchNotfound: function() {
            ...
            if ($("div").hasClass("busca-vazio") == true) {
                ...
                var titleSearch = window.location.pathname.replace('/', "");
                $(".searchNotfound h3.oopsTg").text("Não Encontramos Nenhum Resultado Para  " + decodeURIComponent(titleSearch));
        ...
        destaqueCategoria: function() {
            ...
            //$(".New-BBDI-category .category-search .search-input .search-btn").click(function(){
            //    var inputDestaque = $(".New-BBDI-category .category-search .search-input input").val();
